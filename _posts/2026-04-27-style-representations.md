...
{% include figure.liquid path="assets/img/2026-04-27-style-representations/domainnet_gt_qual.jpg" class="img-fluid" %}
...
{% include figure.liquid path="assets/img/2026-04-27-style-representations/domainnet_densenet_qual.jpg" class="img-fluid" %}

<div class="caption">
    <b>StyleCap</b>
</div>

{% include figure.liquid path="assets/img/2026-04-27-style-representations/domainnet_captions_qual.jpg" class="img-fluid" %}

<div class="caption">
   <b> Mamba</b>
</div>

{% include figure.liquid path="assets/img/2026-04-27-style-representations/domainnet_mamba_qual.jpg" class="img-fluid" %}

<div class="caption">
   <b> CSD</b>
</div>

{% include figure.liquid path="assets/img/2026-04-27-style-representations/domainnet_csd_qual.jpg" class="img-fluid" %}
